...
class DetailedBookSearch(BookSearchSystem):
    ...
    def __init__(self, system_name, location, client_id=None, client_secret=None):
        # 부모 클래스(BookSearchSystem)의 생성자 호출
    ...
    def search_via_api(self, keyword):
        ...
        url = f"https://openapi.naver.com/v1/search/book.json?query={keyword}&display=50"
        headers = {
