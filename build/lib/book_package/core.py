...
class BookSearchSystem:
    ...
    def __init__(self, system_name: str) -> None:
        ...
        self._book_database: List[Dict[str, str]] = [
            {"title": "Python Programming",
             "author": "John Doe", "genre": "Tech"},
            {"title": "Learning Python",
             "author": "Jane Smith", "genre": "Tech"},
            {"title": "The Great Gatsby",
             "author": "F. Scott Fitzgerald", "genre": "Fiction"},
            {"title": "Sherlock Holmes",
             "author": "Arthur Conan Doyle", "genre": "Mystery"},
        ]
    ...
    def get_system_status(self) -> str:
        ...
        :return: 시스템 상태 메시지
        """
        return (f"[{self.system_name}] 시스템이 정상 가동 중입니다. "
                f"총 {len(self._book_database)}권의 도서가 로드되었습니다.")
